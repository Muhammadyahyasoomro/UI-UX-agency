...
import { Search, Layout, Palette, TestTube, Users, Zap, Figma, IterationCw } from "lucide-react";
import { motion } from "framer-motion";
import { InfiniteMovingProcessCards } from "./ui/infinite-moving-cards";
    ...
    const designProcess = [
        {
            ...
            title: "User Research",
            description: "Deep dive into user behaviors, needs & pain points through interviews and analytics.",
            bg: "bg-gradient-to-br from-indigo-900/80 to-purple-900/80",
        },
        {
            icon: <Search className="w-8 h-8 text-orange-500" />,
            title: "Competitive Analysis",
            description: "Evaluate market landscape to identify opportunities and differentiators.",
            bg: "bg-gradient-to-br from-cyan-900/80 to-blue-900/80",
        },
        {
            icon: <Layout className="w-8 h-8 text-orange-500" />,
            title: "Information Architecture",
            description: "Structure content logically for intuitive navigation and findability.",
            bg: "bg-gradient-to-br from-emerald-900/80 to-teal-900/80",
        },
        {
            icon: <Figma className="w-8 h-8 text-orange-500" />,
            title: "Wireframing",
            description: "Create low-fidelity blueprints to establish layout and functionality.",
            bg: "bg-gradient-to-br from-amber-900/80 to-yellow-900/80",
        },
        {
            icon: <Palette className="w-8 h-8 text-orange-500" />,
            title: "UI Design",
            description: "Craft visually appealing interfaces with brand-aligned aesthetics.",
        ...
        },
        {
            ...
            description: "Validate designs with real users to uncover improvement areas.",
            ...
            <div className="container mx-auto px-4">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                        My <span className="text-orange-500">Design</span> Process
                    </h2>
                    <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                        A human-centered approach that transforms problems into elegant, functional solutions.
                    </p>
                </motion.div>
                ...
                <div className="h-[16rem] relative">
                    <InfiniteMovingProcessCards
                        ...
                        pauseOnHover={true}
                        cardComponent={(item) => (
                            <div className={`${item.bg} p-6 rounded-2xl h-full w-[350px] border border-white/10 backdrop-blur-md shadow-lg`}>
